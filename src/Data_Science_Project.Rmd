...
Ahora haremos lo mismo para las variables categóricas. Usaremos la prueba chi cuadrada para determina rsi existe una relación significativa. Si el valor p es menor que 0.05, entonces existe evidencia de una asociación significativa entre las variables.
